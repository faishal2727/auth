...
mixin _$LoginEvent {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(LoginRequest login) doLogin,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function()? started,
    TResult? Function(LoginRequest login)? doLogin,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$DoLoginImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({LoginRequest login});

  $LoginRequestCopyWith<$Res> get login;
}
...
class __$$DoLoginImplCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  $LoginRequestCopyWith<$Res> get login {
    return $LoginRequestCopyWith<$Res>(_value.login, (value) {
...
class _$DoLoginImpl with DiagnosticableTreeMixin implements DoLogin {
  const _$DoLoginImpl(this.login);
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'LoginEvent.doLogin(login: $login)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'LoginEvent.doLogin'))
...
abstract class DoLogin implements LoginEvent {
  const factory DoLogin(final LoginRequest login) = _$DoLoginImpl;
...
abstract class Success implements LoginState {
  const factory Success(final LoginResponse response) = _$SuccessImpl;
